...
public class Test {
	...
	private final static String[] chessName = new String[] { null, null, null,
			null, null, null, null, null, "Tướng", "Sĩ", "Tượng", "Mã", "Xe", "Pháo",
			"Tốt", null, "Tướng", "Sĩ", "Tượng", "Mã", "Xe", "Pháo", "Tốt", null };
	...
	private static boolean youMove(Engine engine) {
		...
		while (true) {
			while (true) {
				...
				Pattern p = Pattern
						.compile("\\s*([0-9])\\s*([0-9])\\s*([0-9])\\s*([0-9])\\s*");
